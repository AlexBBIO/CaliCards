...
- Trim size **3.5" × 2"** (US standard), files are **4" × 2.5"** with
  1/4" bleed on each side — backgrounds run to the edge, text stays in the
  safe zone.
- PNGs are **300 dpi** (1200 × 750). Most printers accept PNG directly.
